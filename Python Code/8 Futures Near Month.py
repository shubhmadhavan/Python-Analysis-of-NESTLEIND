...
df = pd.read_excel('Futures Near Month.xlsx',index_col=0) 
...
df['Daily Return'].plot(kind='line',title='Line Graph for Unadjusted Daily Returns of Near Month')
plt.show()
df_Weekly.plot(kind='line',title='Line Graph for Unadjusted Weekly Returns of Near Month')
plt.show()
df_Monthly.plot(kind='line',title='Line Graph for Unadjusted Monthly Returns of Near Month')
plt.show()