...
df = pd.read_excel('Futures Far Month.xlsx',index_col=0) 
...
df['Daily Return'].plot(kind='line',title='Line Graph for Unadjusted Daily Returns of Far Month')
plt.show()
df_Weekly.plot(kind='line',title='Line Graph for Unadjusted Weekly Returns of Far Month')
plt.show()
df_Monthly.plot(kind='line',title='Line Graph for Unadjusted Monthly Returns of Far Month')
plt.show()